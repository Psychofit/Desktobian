...
Item {
    ...
    WebEngineView {
        ...
        userScripts: [
            ...
            // Inject the user's property overrides before the page's own scripts,
            // so the shim applies the customised values on first paint (no flash
            // of the defaults). JSON.parse at runtime keeps a malformed config
